                                ...
                                <div class="flex flex-wrap -m-2">
                                  ...
                                  <div class="p-2 w-full">
                                    <div class="relative">
                                      ...
                                      <input type="radio" id="is_selling" name="is_selling" v-model="form.is_selling" class="ml-2" value="1">
                                      <label class="ml-2 mr-4">販売中</label>
                                      <input type="radio" id="is_selling" name="is_selling" v-model="form.is_selling" class="ml-2" value="0">
