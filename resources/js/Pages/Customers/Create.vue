                                ...
                                <div class="flex flex-wrap -m-2">
                                  ...
                                  <div class="p-2 w-full">
                                    <div class="relative">
                                      ...
                                      <input type="radio" id="gender0" name="gender" v-model="form.gender" class="ml-2" value="0">
                                      <label for="gender0" class="ml-2 mr-4">男性</label>
                                      <input type="radio" id="gender1" name="gender" v-model="form.gender" class="ml-2" value="1">
                                      <label for="gender1" class="ml-2 mr-4">女性</label>
                                      <input type="radio" id="gender2" name="gender" v-model="form.gender" class="ml-2" value="2">
